...
function EmployeeManagementPage() {
    return ((0, jsx_runtime_1.jsx)(shared_layout_1.SharedLayout, { children: (0, jsx_runtime_1.jsx)(EmployeeManagementContent, {}) }));
}
function EmployeeManagementContent() {
    ...
    }), sortConfig = _f[0], _setSortConfig = _f[1];
    var _g = (0, react_1.useState)([]), selectedEmployees = _g[0], setSelectedEmployees = _g[1];
    var _h = (0, react_1.useState)(false), isAddEmployeeOpen = _h[0], setIsAddEmployeeOpen = _h[1];
    var _j = (0, react_1.useState)(null), editingEmployee = _j[0], setEditingEmployee = _j[1];
    var _k = (0, react_1.useState)(null), viewingEmployee = _k[0], setViewingEmployee = _k[1];
    ...
    }), _m = _l["data"], employees = _m === void 0 ? [] : _m, isLoading = _l.isLoading, error = _l.error, refetch = _l.refetch;
    ...
    var handleBulkDelete = function () {
        ...
        if (typeof window !== 'undefined' && window.confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 ".concat(selectedEmployees.length, " \u0645\u0648\u0638\u0641\u061F"))) {
    ...
    var filteredEmployees = employees
        ...
        var minOk = salaryRange.min === '' || employee.salary >= Number(salaryRange.min);
        var maxOk = salaryRange.max === '' || employee.salary <= Number(salaryRange.max);
