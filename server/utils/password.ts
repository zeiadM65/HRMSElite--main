...
import {hash as hashPasswordInternal, verify as verifyPasswordInternal} from '../security/password';
...
export const hashPassword = async (password: string): Promise<string> => {
  ...
  try {
    ...
    return await hashPasswordInternal(password);
...
export const verifyPassword = async (password: string, hash: string): Promise<boolean> => {
  ...
  try {
    ...
    return await verifyPasswordInternal(hash, password);
