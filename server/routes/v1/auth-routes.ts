...
publicAuthRouter.use((_req, res, next) => {
  res.setHeader('Cache-Control', 'no-store');
  next();
});

privateAuthRouter.use((_req, res, next) => {
  res.setHeader('Cache-Control', 'no-store');
  next();
});
 ...
 */
privateAuthRouter.get('/user', async (req: Request, res: Response) => {
  try {
 ...
 */
publicAuthRouter.post('/login', async (req: Request, res: Response) => {
  try {
 ...
 */
publicAuthRouter.post('/register', async (req: Request, res: Response) => {
  try {
 ...
 */
privateAuthRouter.post('/logout', async (req: Request, res: Response) => {
  try {
 ...
 */
publicAuthRouter.post('/refresh', async (req: Request, res: Response) => {
  try {
    const refreshToken = getRefreshTokenFromRequest(req);
 ...
 */
publicAuthRouter.post('/forgot-password', async (req: Request, res: Response) => {
  try {
 ...
 */
publicAuthRouter.post('/reset-password', async (req: Request, res: Response) => {
  try {
 ...
 */
publicAuthRouter.post('/verify-email', async (req: Request, res: Response) => {
  try {
